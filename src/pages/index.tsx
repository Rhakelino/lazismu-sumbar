...
const Home: React.FC = () => {
  ...
  return (
    <div>
      ...
      {/* Info Box */}
      <div data-aos="fade-up" className="relative mt-[-40px] z-10 bg-orange-400 text-white shadow-lg rounded-2xl mx-4 sm:mx-0 p-6 flex flex-col sm:flex-row justify-around text-center">
