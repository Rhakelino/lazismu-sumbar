...
const Program = () => {
  ...
  const categories = [
    ...
    { name: "Pilar Pendidikan", color: "amber" },
    { name: "Pilar Kesehatan", color: "emerald" },
    { name: "Pilar Ekonomi", color: "orange" },
    { name: "Pilar Kemanusiaan", color: "cyan" },
    { name: "Pilar Sosial Dakwah", color: "violet" },
    { name: "Pilar Lingkungan", color: "violet" },
  ];
  ...
  const programs = [
    {
      ...
      deskripsi:
        "Salurkan qurban terbaik Anda untuk masyarakat pelosok Indonesia.",
      ...
      <div className="flex flex-wrap justify-center gap-4  my-8">
        {categories.map((cat) => (
          <button
            ...
            className={`min-w-[150px] px-6 py-3 rounded text-base font-medium transition text-center ${
        ...
        {paginatedPrograms.map((program) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              <a
                href={`/donasi-form?programSlug=${
                  program.slug
                }&programName=${encodeURIComponent(
                  program.judul
